...
pub fn circle_rect_intersect(c: Point2, r: f64, corners: Vec<Point2>) -> bool {
    let p1 = corners[0]
        - project(
            Vec2::new_from_point(corners[0] - c),
            Vec2::new(corners[1].x - corners[0].x, corners[1].y - corners[0].y),
        );
    ...
    let p2 = corners[0]
        - project(
            Vec2::new_from_point(corners[0] - c),
            Vec2::new(corners[2].x - corners[0].x, corners[2].y - corners[0].y),
        );
    ...
    let p3 = corners[2]
        - project(
            Vec2::new_from_point(corners[0] - c),
            Vec2::new(corners[3].x - corners[2].x, corners[3].y - corners[2].y),
        );
    ...
    let p4 = corners[1]
        - project(
            Vec2::new_from_point(corners[0] - c),
            Vec2::new(corners[3].x - corners[1].x, corners[3].y - corners[1].y),
        );
...
mod collision_tests {
    ...
    fn test_point_on_line() {
        ...
        let l1 = Point2 { x: 0.0, y: 0.0 };

        let l2 = Point2 { x: 4.0, y: 2.0 };
