...
use crate::game::consts::{
    BULLET_HEIGHT, TOWER_CANNON_COLOR, TOWER_CANNON_HEIGHT, TOWER_CANNON_WIDTH, TOWER_COLOR,
    TOWER_RADIUS, TOWER_RANGE, TOWER_SIZE,
};
use crate::math::Point2;
use crate::math::Vec2;
use crate::traits::draw::{Context, Draw, GenericShape, Graphics, ShapeVariant};
...
impl Tower {
    ...
    pub fn new(position: Point2) -> Self {
        ...
        Self {
            ...
            bullet: Bullet::new(Point2 { x: 0.0, y: 0.0 }, Vec2::new(0.0, 0.0)),
        }
    }
